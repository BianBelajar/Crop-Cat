...
# ── TAMBAHKAN BARIS INI ──────────────────────────────────────────────────────
const ACHIEVEMENT_SAVE_FILE: String = "achievements.save"

## Mengembalikan path file save achievement milik user aktif.
func get_achievement_save_path() -> String:
	return get_user_save_dir() + ACHIEVEMENT_SAVE_FILE
# ─────────────────────────────────────────────
...
func save_game() -> void:
	...
	# ── TAMBAHKAN BARIS INI ──────────────────────────────────────────────────
	# 3. Simpan data achievement
	AchievementManager.save_to_path(get_achievement_save_path())
	# ── SELESAI TAMBAHAN ─────────────────────────────────────────────────────
...
func load_game() -> void:
   ...
   # 1. Muat data quest
	...
	# ── TAMBAHKAN BARIS INI ──────────────────────────────────────────────────
	# 2. Muat data achievement
	AchievementManager.load_from_path(get_achievement_save_path())
	# ── SELESAI TAMBAHAN ─────────────────────────────────────────────────────
